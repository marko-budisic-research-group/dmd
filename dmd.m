...
%         If VALUE = [], the code does not compute b coefficients but
%                        exits as soon as eigenvalues/modes are computed.
%         Default: VALUE = 1 (fit at the initial condition)
%
...
out.sigma = sigma;
out.subspaceSize = subspaceSize;
out.numericalRankTolerance = options.numericalRankTolerance;
